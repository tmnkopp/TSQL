--TESTING DEFAULTS
	...
	DECLARE @HVASubmissionDate DATE = '2020-07-23'--GETDATE()--< SET THIS TO DATE WHEN HVA SUBMITTED, USE CURRENT DATE FOR PERFORMANCE TESTING
...
--BEGIN QUERY
	...
	SET @exe=@exe+') P ORDER BY HVA DESC, PK_PrimeKey DESC' 
