DECLARE @PK_FORM_TO NVARCHAR(15) = '2018-Q1-CIO'  
DECLARE @AG_ACRONYM NVARCHAR(5) = 'DOE'   
...
WHERE ( PK_FORM LIKE '%16'+@PK_FORM_TYPE OR PK_FORM LIKE '%17'+@PK_FORM_TYPE    ) AND QPKTO IS NOT NULL
